...
export const createTable = (columnsArray, dataArray, tableId) => {
    if(!isNonEmptyArray(columnsArray) || !isNonEmptyArray(dataArray) || !tableId ) {
        throw new Error("para a correta execução, precisamos de um array com as colunas, outro com as informaçoes das linhas e tambem o id do elemento tabela selecionado")
    }
