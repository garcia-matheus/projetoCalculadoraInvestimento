...
const columnsArray = [
	...
	{ columnLabel:'Rendimento Total', accessor: 'totalInterstReturns', format: (numberInfo) => formatCurrency(numberInfo)},
        ...
        datasets: [
            {
                ...
                formatCurrencyToGraph(finalInvestmentObject.totalInterstReturns * (1 - taxRate/100)), 
                formatCurrencyToGraph(finalInvestmentObject.totalInterstReturns * (taxRate/100)),
                ],
                backgroundColor: [
                    'rgb(255, 99, 132)',
                    'rgb(54, 162, 235)',
